...
export const ResponsiveHeader = () => {
  ...
  <span style={{ position: 'relative', display: 'inline-block' }}>
    <Icon
      ...
      style={{ color: "black" }}
    />
    <span style={{ fontSize: '0.7em', position: 'absolute', top: '-10px', right: '-10px', backgroundColor: 'black', borderRadius: '100%', width: '15px', height: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white' }}>0</span>
  </span>
